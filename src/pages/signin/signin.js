  ...
  return (
    <div className='containerr'>
      <div className='row'>
        ...
        <div className='col-6 container-fluid d-flex justify-content-center align-items-center align-self-center' style={{ position: 'absolute', top: '50%', left: '0px', transform: 'translate(0,-50%)', }}>
          ...
          <form onSubmit={Submit} className='d-flex flex-column align-items-center ' style={{ width: "40%", border: '2px solid white', padding: '20px' }}>
            ...
            <div className="input-group mb-3">
              ...
              <input type="password" className="form-control" aria-label="Username" name='passWord' value={passWord} onChange={(ev) => setPassWord(ev.target.value)} />
            </div>
